...
:hi Search guibg=#302028 guifg=#f0a0c0 cterm=underline gui=underline ctermfg=Magenta ctermbg=None
...
:hi PreProc guifg=orangered guibg=grey15 ctermfg=red
:hi Operator guifg=orangered ctermfg=Red
:hi Define guifg=SkyBlue gui=bold ctermfg=yellow
:hi Type guifg=CornflowerBlue ctermfg=2
:hi Function guifg=navajowhite ctermfg=brown
:hi Structure guifg=green ctermfg=green
:hi LineNr guifg=grey50 ctermfg=3
:hi Ignore guifg=grey40 cterm=bold ctermfg=7
:hi Todo guifg=orangered guibg=grey40
