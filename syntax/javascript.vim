...
syntax keyword javascriptIdentifier     self arguments this let var void yield
...
syntax keyword javascriptGlobal         top parent
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javascriptDocNotation          Comment
  HiLink javascriptDocTags              Comment
  HiLink javascriptDocSeeTag            Comment
  HiLink javascriptDocParam             Comment
  HiLink javascriptDocNamedParamType    Comment
  HiLink javascriptDocParamName         Comment
  HiLink javascriptDocParamType         Comment
  ...
  HiLink javascriptFuncKeyword          javaScriptFunction
  ...
  HiLink javascriptFuncDef              Function
  HiLink javascriptFuncExp              Function
  HiLink javascriptFuncArg              Special
  HiLink javascriptFuncComma            Special  
